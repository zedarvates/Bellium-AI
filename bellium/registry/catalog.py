...
SPECIALISTS: tuple[SpecialistSpec, ...] = (
    ...
    SpecialistSpec("bellium/hybrid/engine-import-validation:v0", "hybrid", "engine-import", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Declared contract, findings and a manifest mirror; no engine runs and no file is written."),
    SpecialistSpec("bellium/hybrid/atlas-raster:v0", "hybrid", "atlas-raster", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Exact pixel copies and PNG bytes; pages are re-derived and compared first."),
    SpecialistSpec("bellium/hybrid/atlas-dedup:v0", "hybrid", "atlas-dedup", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Exact duplicates only: one stored copy per distinct image, alias map verified."),
    SpecialistSpec("bellium/hybrid/normal-to-height:v0", "hybrid", "pbr-height", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Integrates a normal field into a relative height; the additive constant is not recoverable and the pixel scale is declared."),
    SpecialistSpec("bellium/knn/integration-method:v0", "knn", "pbr-height", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Recommendation only: names an integrator and returns the published rule's answer beside it."),
    SpecialistSpec("bellium/hybrid/normal-map-convention:v0", "hybrid", "pbr-normals", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Declared handedness: the symptoms are reported, the flip is applied on request, and nothing is written."),
    SpecialistSpec("bellium/hybrid/normal-mip-chain:v0", "hybrid", "pbr-normals", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Reductions of a normal field with the drift of the chain; pixels above the declared budget are refused."),
    SpecialistSpec("bellium/hybrid/ambient-occlusion:v0", "hybrid", "pbr-ao", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Horizon-based ambient occlusion estimation from height or normal fields; output is purely geometric accessibility."),
    SpecialistSpec("bellium/nano-nn/resample-edge:v0", "nano-nn", "resample-edge", "bellium-native", AuthorityMode.CONSULTATIVE, False, "38-parameter nano-NN edge-directed residual regressor for high-frequency scaling."),
    SpecialistSpec("bellium/knn/resample-knn:v0", "knn", "resample-knn", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Exemplar subpixel orientation pattern matching for edge-preserving resampling."),
    SpecialistSpec("bellium/nano-nn/quantize-tone:v0", "nano-nn", "quantize-tone", "bellium-native", AuthorityMode.CONSULTATIVE, False, "25-parameter nano-NN dither arbiter preventing banding on gradients while avoiding noise on flat areas."),
    SpecialistSpec("bellium/knn/palette-match:v0", "knn", "palette-match", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Perceptual k-NN nearest exemplar color assignment with quantization loss diagnostics."),
    SpecialistSpec("bellium/nano-nn/adaptive-filter:v0", "nano-nn", "adaptive-filter", "bellium-native", AuthorityMode.CONSULTATIVE, False, "30-parameter nano-NN adaptive blending between local sharpening and noise smoothing."),
    SpecialistSpec("bellium/knn/filter-selector:v0", "knn", "filter-selector", "bellium-native", AuthorityMode.CONSULTATIVE, False, "k-NN image feature vector classifier selecting optimal spatial filter presets."),
    SpecialistSpec("bellium/micro-nn/tone-curve:v0", "micro-nn", "tone-curve", "bellium-native", AuthorityMode.CONSULTATIVE, False, "108-parameter micro-NN parametric tone curve regressor for balanced exposure."),
    SpecialistSpec("bellium/knn/adaptive-threshold:v0", "knn", "adaptive-threshold", "bellium-native", AuthorityMode.CONSULTATIVE, False, "k-NN document and silhouette classifier selecting optimal binarization strategy."),
    SpecialistSpec("bellium/knn/hash-matcher:v0", "knn", "perceptual-hash", "bellium-native", AuthorityMode.CONSULTATIVE, False, "k-NN perceptual hash and near-duplicate retrieval with Hamming distance ranking."),
    SpecialistSpec("bellium/knn/vector-region:v0", "knn", "raster-to-svg", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Names a region flat_fill, thin_stroke or photo_texture before tracing."),
    SpecialistSpec("bellium/hybrid/raster-to-svg:v0", "hybrid", "raster-to-svg", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Quantize, trace pixel-square contours, emit SVG; textured regions abstain."),
    SpecialistSpec("bellium/hybrid/magick-replacement:v0", "hybrid", "image-magick-replacement", "bellium-native", AuthorityMode.CONSULTATIVE, False, "Unified pure-Python/pure-math ImageMagick replacement suite covering resize, quantize, filter, tone, binarize, transform and compare."),
    SpecialistSpec("bellium/deterministic/drafting-document:v0", "deterministic", "drafting-document", "bellium-native", AuthorityMode.CONSULTATIVE, False, "2D document with units, layers and exact primitives; SVG and DXF R12 round-trip. No pixels."),
)
